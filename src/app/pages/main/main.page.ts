...
import { IonAccordion, IonAccordionGroup, IonButton, IonButtons, IonCol, IonContent, IonGrid, IonHeader, IonIcon, IonImg, IonInput, IonItem, IonLabel, IonMenu, IonMenuButton, IonRouterOutlet, IonRow, IonSelect, IonSelectOption, IonTitle, IonToolbar, MenuController, ModalController, NavController } from '@ionic/angular/standalone';
...
export class MainPage implements OnInit {
  ...
  someForThatVehicle(id:string){
    if(this.eventsArray.some((event:Event)=>event.vehicleId === id)){
      return true;
    }else{
      return false;
    }
